...
public class UsersResource {
	...
	public Response putUser(User userUpdate, @PathParam("userId") long userId, @Context HttpServletRequest request)
			throws Exception {
		Connection conn = (Connection) sc.getAttribute("dbConn");
		UserDAO userDao = new JDBCUserDAOImpl();
		userDao.setConnection(conn);
		...
		response = Response // return 201 and Location: /users/newid
